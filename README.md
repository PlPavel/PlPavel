...
Привет! Я Павел, студент 4 курса МТУСИ и программист с интересом к разработке приложений на языке Swift. 
...
- Базы данных: PostgreSQL, CoreData
- Инструменты: Git
...
Образование:
- Студент 4 курса МТУСИ по направлению “Фундаментальная информатика и информационные технологии”
